...
class LoginTestScript {
  ...
  private screenshotDir = './exported-screenshots';
   ...
   */
  async runLoginTest(): Promise<TestResult[]> {
    const browsers = [
  ...
  private async testWithBrowser(
    ...
    try {
      ...
      let screenshotPath = path.join(
        this.screenshotDir,
        `${browserName}-step1-login-page.png`
      );
      ...
      screenshotPath = path.join(
        this.screenshotDir,
        `${browserName}-step2-username-filled.png`
      );
      await page.screenshot({ path: screenshotPath });
      screenshots.push(screenshotPath);
      ...
      screenshotPath = path.join(
        this.screenshotDir,
        `${browserName}-step3-password-filled.png`
      );
      await page.screenshot({ path: screenshotPath });
      screenshots.push(screenshotPath);
      ...
      screenshotPath = path.join(
        this.screenshotDir,
        `${browserName}-step4-login-clicked.png`
      );
      await page.screenshot({ path: screenshotPath });
      screenshots.push(screenshotPath);
   ...
   */
  exportToJSON(filename = 'test-results.json'): void {
    const jsonResults = {
